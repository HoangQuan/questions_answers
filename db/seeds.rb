...
Question.create(user_id: User.first.try(:id) || 1, category_id: 1, title: "Trong những cách sau cáth nào có thể làm nhiễm điện cho một vật?", content: "1. Trong những cách sau cách nào có t?", level_id: 11, points: 10, remain_points: 10, difficulty_level: 'easy')
...
Question.create(user_id: User.first.try(:id) || 1, category_id: 1, title: "Trong các hiện tượng sau, hiện tượng nào không liên quan đến nhiễm điện?", content: "Trong các hiện tượng sau, hiện tượng nào không liên quan đến nhiễm điện?", level_id: 11, points: 10, remain_points: 10, difficulty_level: 'normal')
